...
public class TodoListTerminalView implements TodoListView{
    ...
    private static TodoListServices todoListServices = null;
    ...
    public void showMenuRemoveTodoList() {
        ...
        if (number.equals("x")) {
            ...
            boolean success = todoListServices.addtodoList(Integer.valueOf(number));
            if (!success) {
    ...
    public static void showMenuAddTodoList() {
        ...
        if (todo.equals("x")) {
            ...
            todoListServices.removedTodoList(todo);
        }
    }
